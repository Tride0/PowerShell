...
Function Get-RegistryValue
{
    ...
    Function Select-Choice
    {
        ...
        Switch (Read-host -Prompt $Prompt)
        {
            ...
            { ((1..$($Options.Count)) -contains $_ ) } { Return [int]$_ }
            ...
            Default { 
                ...
                Else
                {
                    ...
                    {
                        Remove-Variable -Name AllOptions -Scope Script -ErrorAction SilentlyContinue
                        Return $Options.IndexOf("$PossibleOptions")+1
                    }
                ...
                Select-Choice -Options $Options -PromptPrefix $PromptPrefix -OtherOptions $OtherOptions
            }
        }
    }
    ...
    Function Navigate
    {
        ...
        :SubKey While ($Choice -ne 'Stay')
        {
            ...
            If ($Choice -is [int])
            {
                $CurrentKeyLocation = $CurrentKeyLocation.OpenSubKey($SubKeys[($Choice-1)])
            }
    ...
    Function Get-RegValue
    {
        ...
        Switch ($Choice)
        {
            ...
            Default { Return $CurrentKeyLocation.GetValue($ValueNames[($Choice-1)]) }
        }
    }
