Function Check-ADHealth {
    ...
    THIS SCRIPT SHOULD BE RUN LOCALLY AND NOT REMOTELY. Windows by default doesn't allow credentials to jump twice, so some checks will fail if done remotely.
#>
