...
Write-Host "`n`n`n$(($Groups | ? { $_.'member;range=0-*'.Count -eq 0 -and $_.'member;range=0-1499'.Count -eq 0 -and $_.'memberof'.Count -eq 0 }).Count) groups without any members or memberships."
