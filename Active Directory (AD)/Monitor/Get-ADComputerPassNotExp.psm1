Function Get-ADComputerPassNotExp {
    <#
        .NOTES
        ...
        .DESCRIPTION
            Get AD Computer Objects with their password set to not expire
    #>
    Begin {
        $ADSearcher = [DirectoryServices.DirectorySearcher]@{
            ...
            PageSize = 3 
            Filter   = '(&(objectClass=computer)(userAccountControl:1.2.840.113556.1.4.803:=65536))'
        }
    }
    Process {
